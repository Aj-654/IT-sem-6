...
import 'read_chapter_model.dart';
export 'read_chapter_model.dart';

class ReadChapterWidget extends StatefulWidget {
  const ReadChapterWidget({
    super.key,
    required this.book,
  });
...
class _ReadChapterWidgetState extends State<ReadChapterWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadChapterModel());
  }
              ...
              StreamBuilder<List<ChaptersRecord>>(
                stream: queryChaptersRecord(
                  ...
                  queryBuilder: (chaptersRecord) =>
                      chaptersRecord.orderBy('chapterNo'),
                ),
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  listViewChaptersRecord.chapterNo.toString(),
                                  style:
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  listViewChaptersRecord.chapterTitle,
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ),
                              ),
