...
class _BookInfoWidgetState extends State<BookInfoWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BooksRecord>(
      stream: BooksRecord.getDocument(widget.book!),
      builder: (context, snapshot) {
        ...
        final bookInfoBooksRecord = snapshot.data!;
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      bookInfoBooksRecord.authorName,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                            fontFamily: 'Urbanist',
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 24.0),
                            child: Text(
                              bookInfoBooksRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (bookInfoBooksRecord.authorID ==
                                  currentUserUid)
                                FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
