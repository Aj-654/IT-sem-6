...
import 'create_book1_widget.dart' show CreateBook1Widget;
...
class CreateBook1Model extends FlutterFlowModel<CreateBook1Widget> {
  ...
  // State field(s) for BookDescription widget.
  FocusNode? bookDescriptionFocusNode;
  TextEditingController? bookDescriptionController;
  String? Function(BuildContext, String?)? bookDescriptionControllerValidator;
  ...
  void dispose() {
    ...
    bookDescriptionFocusNode?.dispose();
